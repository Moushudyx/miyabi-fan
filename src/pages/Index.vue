...
useHead({
  ...
  meta: [
    {
      name: 'description',
      content: '星见雅角色粉丝站，包含视觉展示、同人作品与官方情报、周边信息',
    },
  ],
})
</script>
...
<template>
  <PageSlider>
    <PageSection id="hero" title="星见雅视觉">
      <HeroSection />
    </PageSection>
    <PageSection id="fan-works" title="同人作品">
      <FanWorksSection />
    </PageSection>
    <PageSection id="official" title="官方情报">
      <OfficalInfoSection />
    </PageSection>
    <PageSection id="footer" title="社交媒体">
      <FooterSection />
    </PageSection>
  </PageSlider>
</template>
